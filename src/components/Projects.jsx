        ...
        >
          <VStack align="start" spacing={6} flex={1}>
            ...
            <Text fontSize={{ base: "md", md: "lg" }} color={useColorModeValue("gray.600", "gray.300")}>
              ...
              platform that precisely classifies honeybees, pollen carriers, and drones. The solution unites advanced computer vision
              with intuitive dashboards tailored for field technicians and research teams.
            </Text>
